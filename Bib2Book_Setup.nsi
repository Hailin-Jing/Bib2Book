...
Section "MainSection" SEC01
  ...
  SetOutPath "$INSTDIR\documentation\example"
  File "release\documentation\example\aicescover.sty"
  SetOutPath "$INSTDIR\documentation\example\aiceslogos"
  File "release\documentation\example\aiceslogos\aices.eps"
  File "release\documentation\example\aiceslogos\aices.pdf"
  File "release\documentation\example\aiceslogos\rwth.eps"
  File "release\documentation\example\aiceslogos\rwth.pdf"
  File "release\documentation\example\aiceslogos\tongji.png"
  SetOutPath "$INSTDIR\documentation\example"
  File "release\documentation\example\Ching2012-Modeling parameters of structured clays as a multivariate normal distribution.pdf"
  File "release\documentation\example\Ching2014-Correlations among some clay parameters - the multivariate distribution.pdf"
  File "release\documentation\example\Ching2014-Modeling piezocone cone penetration (CPTU) parameters of clays as a multivariate normal distribution.pdf"
  File "release\documentation\example\Ching2014-Transformations and correlations among some clay parameters - the global database.pdf"
  File "release\documentation\example\Ching2017-Transformation models for effective friction angle and relative density calibrated based on generic database of coarse-grained soils.pdf"
  File "release\documentation\example\Ching2018-Generic transformation models for some intact rock properties.pdf"
  File "release\documentation\example\Ching2020-Quasi-site-specific prediction for deformation modulus of rock mass.pdf"
  File "release\documentation\example\Compile.bat"
  File "release\documentation\example\Cover.pdf"
  File "release\documentation\example\Cover.tex"
  File "release\documentation\example\D’Ignazio2016-Correlations for undrained shear strength of Finnish soft clays.pdf"
  File "release\documentation\example\example.b2b"
  File "release\documentation\example\example.pdf"
  File "release\documentation\example\example.tex"
  File "release\documentation\example\Feng2019a-A database of saturated hydraulic conductivity of fine-grained soils- probability density functions.pdf"
  File "release\documentation\example\Feng2019b-Full AccessCorrelation of the hydraulic conductivity of fine-grained soils with water content ratio using a database.pdf"
  File "release\documentation\example\Liu2016-Multivariate correlation among resilient modulus and cone penetration test parameters of cohesive subgrade soils.pdf"
  SetOutPath "$INSTDIR\documentation\example\PDFs"
  File "release\documentation\example\PDFs\Ching2012-Modeling parameters of structured clays as a multivariate normal distribution.pdf"
  File "release\documentation\example\PDFs\Ching2014-Correlations among some clay parameters - the multivariate distribution.pdf"
  File "release\documentation\example\PDFs\Ching2014-Modeling piezocone cone penetration (CPTU) parameters of clays as a multivariate normal distribution.pdf"
  File "release\documentation\example\PDFs\Ching2014-Transformations and correlations among some clay parameters - the global database.pdf"
  File "release\documentation\example\PDFs\Ching2017-Transformation models for effective friction angle and relative density calibrated based on generic database of coarse-grained soils.pdf"
  File "release\documentation\example\PDFs\Ching2018-Generic transformation models for some intact rock properties.pdf"
  File "release\documentation\example\PDFs\Ching2020-Quasi-site-specific prediction for deformation modulus of rock mass.pdf"
  File "release\documentation\example\PDFs\D’Ignazio2016-Correlations for undrained shear strength of Finnish soft clays.pdf"
  File "release\documentation\example\PDFs\Feng2019a-A database of saturated hydraulic conductivity of fine-grained soils- probability density functions.pdf"
  File "release\documentation\example\PDFs\Feng2019b-Full AccessCorrelation of the hydraulic conductivity of fine-grained soils with water content ratio using a database.pdf"
  File "release\documentation\example\PDFs\Liu2016-Multivariate correlation among resilient modulus and cone penetration test parameters of cohesive subgrade soils.pdf"
  File "release\documentation\example\PDFs\Zhang dongming 2020-Multivariate probability distribution of shanghai clay properties.pdf"
  SetOutPath "$INSTDIR\documentation\example"
  File "release\documentation\example\Zhang dongming 2020-Multivariate probability distribution of shanghai clay properties.pdf"
...
Section Uninstall
  ...
  Delete "$INSTDIR\documentation\doc.synctex.gz"
  Delete "$INSTDIR\documentation\doc.pdf"
  Delete "$INSTDIR\documentation\doc.out"
  Delete "$INSTDIR\documentation\doc.log"
  Delete "$INSTDIR\documentation\doc.aux"
